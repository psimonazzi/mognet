/* Rainbow v1.1.2 rainbowco.de | included languages: generic, shell, javascript, html, css */
...
pattern:/(\w+)/g}]},pattern:/(&lt;\/?)(script(.*?))(&gt;)/g},{name:"regex",matches:{1:"regex.open",2:{name:"constant.regex.escape",pattern:/\\(.){1}/g},3:"regex.close",4:"regex.modifier"},pattern:/(\/)(.+)(\/)([igm]{0,3})/g},{name:"meta.function-call",pattern:/(\w+)(?=:\s{0,}function)/g}]);Rainbow.extend("html",[{name:"php",matches:{2:{language:"php"}},pattern:/&lt;\?(php)?([\s\S]*?)(\?&gt;)/gm},{name:"css",matches:{"0":{language:"css"}},pattern:/&lt;style(.*?)&gt;([\s\S]*?)&lt;\/style&gt;/gm},{name:"js",matches:{"0":{language:"javascript"}},pattern:/&lt;script(?! src)(.*?)&gt;([\s\S]*?)&lt;\/script&gt;/gm},{name:"comment.html",pattern:/&lt;\!--[\S\s]*?--&gt;/g},{matches:{1:"support.tag.open",2:"support.tag.close"},pattern:/(&lt;)|(\/?&gt;)/g},{name:"support.tag",matches:{1:"support.tag",
2:"support.tag.special",3:"support.tag-name"},pattern:/(&lt;)(\/|\!?)(\w+)/g},{matches:{1:"support.attribute"},pattern:/([a-z-]+)(?=\=)/g},{matches:{1:"support.operator",2:"string.quote",3:"string.value",4:"string.quote"},pattern:/(=)('|")(.*?)(\2)/g},{matches:{1:"support.operator",2:"support.value"},pattern:/(=)([a-zA-Z\-0-9]*)\b/g},{matches:{1:"support.attribute"},pattern:/\s(\w+)(?=\s|&gt;)(?!.*&lt;)/g}],!0);Rainbow.extend("css",[{name:"comment",pattern:/\/\*[\s\S]*?\*\//gm},{name:"constant.hex-color",pattern:/#([a-fA-F0-9]{3}|[a-fA-F0-9]{6})(?=;|\s)/g},{matches:{1:"integer",2:"keyword.unit"},pattern:/(\d+)(px|cm|s)?/g},{name:"string",pattern:/('|")(.*?)\1/g},{name:"support.css-property",matches:{1:"support.vendor-prefix"},pattern:/(-o-|-moz-|-webkit-|-ms-)?[\w-]+(?=\s?:)(?!.*\{)/g},{matches:{1:[{name:"meta.sass",pattern:/&amp;/g},{name:"direct-descendant",pattern:/&gt;/g},{name:"meta.class",pattern:/\.[\w\-_]+/g},
{name:"meta.id",pattern:/\#[\w\-_]+/g},{name:"meta.pseudo",pattern:/:[\w\-_]+/g},{name:"meta.tag",pattern:/\w+/g}]},pattern:/([\w\ ,:\.\#\&\;\-_]+)(?=.*\{)/g},{matches:{2:"support.vendor-prefix",3:"support.css-value"},pattern:/(:|,)\s?(-o-|-moz-|-webkit-|-ms-)?([a-zA-Z-]*)(?=\b)(?!.*\{)/g},{matches:{1:{name:"meta.style-tag",pattern:/\w+/g}},pattern:/&lt;\/?(.*?)(?=\=|&gt;)/g}],!0);
